import type { InternalToolCall, InternalAssistantResponse } from "./providerProtocol.js";
import { createInternalToolCallId } from "./toolCallIds.js";

export type ProviderKind = "ollama" | "openai" | "anthropic" | "unknown";
...
export function parseInternalAssistantResponse(input: {
  ...
  const msg = (input.rawResponse ?? {}) as Record<string, unknown>;
