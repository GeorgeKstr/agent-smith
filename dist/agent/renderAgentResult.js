...
function renderReadOnly(finalText, evidence) {
    const lines = [];
    if (finalText.trim()) {
...
function renderChanged(finalText, evidence) {
    const lines = [];
    if (finalText.trim()) {
        lines.push(finalText.trim());
    }
...
function renderNoChange(finalText, evidence) {
    const lines = [];
...
function renderPendingApproval(finalText, evidence, pendingOps) {
    const lines = [];
...
function renderPartial(finalText, evidence, result) {
    const lines = [];
    if (finalText.trim()) {
        lines.push(finalText.trim());
    }
...
function renderFailed(finalText, evidence, stopReason) {
    const lines = [];
...
function renderBlocked(finalText, stopReason) {
    const lines = [];
    lines.push("Blocked.");
    if (stopReason) {
        lines.push(`\nReason: ${stopReason.replace(/_/g, " ")}`);
