export function checkEditPressurePolicy(input) {
    ...
    return {
        allowed: false,
        summary: "Edit pressure active. Enough context has been inspected for this patch task. Further searching is blocked until you propose or make a change.",
        nextActions: [
