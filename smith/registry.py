...
TASK_PROFILES: dict[str, TaskProfile] = {
    "ask": TaskProfile(
        name="ask",
        model_profile="fast",
        tools=["list_files", "read_file", "grep_search", "find_files", "search_project_context", "get_file_summary", "get_related_files"],
    ...
    "review": TaskProfile(
        ...
        tools=["read_file", "grep_search", "run_command", "search_project_context", "get_file_summary", "get_run_changes"],
