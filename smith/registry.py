...
TASK_PROFILES: dict[str, TaskProfile] = {
    "ask": TaskProfile(
        name="ask",
        model_profile="fast",
        tools=["ls", "read", "grep", "find", "fetch", "search_project_context", "get_file_summary", "get_related_files"],
    ...
    "review": TaskProfile(
        ...
        tools=["read", "grep", "fetch", "bash", "search_project_context", "get_file_summary", "get_run_changes"],
